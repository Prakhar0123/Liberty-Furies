  ...
  jobs.forEach(job => {
    ...
    card.innerHTML = `
      ...
      <div class="card-footer">
        ...
        ${isHome 
          ? `<a href="${escapeHtml(job.link)}" target="_blank" rel="noopener" class="btn btn-primary">Apply Now</a>` 
          : `<button type="button" class="btn btn-secondary" onclick="openEditModal('${job.id}')">✏️ Edit</button>`
        }
      </div>
    `;
...
function openDetailModal(id) {
  ...
  document.getElementById('detailFooter').innerHTML = isHome 
    ? `<button type="button" class="btn btn-secondary" onclick="closeDetailModal()">Close</button>
       <a href="${escapeHtml(job.link)}" target="_blank" rel="noopener" class="btn btn-primary btn-lg">Apply Now ↗</a>`
    : `<button type="button" class="btn btn-secondary" onclick="closeDetailModal()">Close</button>
